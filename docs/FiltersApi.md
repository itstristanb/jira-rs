...
> crate::models::PageBeanFilterDetails get_filters_paginated(filter_name, account_id, owner, groupname, group_id, project_id, id, order_by, start_at, max_results, expand, override_share_permissions)
Search for filters
