...
> crate::models::PageBeanField get_fields_paginated(start_at, max_results, r#type, id, query, order_by, expand)
...
> crate::models::PageBeanField get_trashed_fields_paginated(start_at, max_results, id, query, expand, order_by)
