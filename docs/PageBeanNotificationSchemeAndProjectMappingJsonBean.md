...
**values** | Option<[**Vec<crate::models::NotificationSchemeAndProjectMappingJsonBean>**](NotificationSchemeAndProjectMappingJsonBean.md)> | The list of items. | [optional][readonly]
