...
> crate::models::PermissionGrant create_permission_grant(scheme_id, request_body, expand)
...
**request_body** | [**::std::collections::HashMap<String, serde_json::Value>**](serde_json::Value.md) | The permission grant to create. | [required] |
