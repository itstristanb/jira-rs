...
> crate::models::IssueArchivalSyncResponse archive_issues(issue_archival_sync_request)
...
[**crate::models::IssueArchivalSyncResponse**](IssueArchivalSyncResponse.md)
...
> serde_json::Value edit_issue(issue_id_or_key, request_body, notify_users, override_screen_security, override_editable_flag, return_issue, expand)
Edit issue
...
> crate::models::ExportArchivedIssuesTaskProgressResponse export_archived_issues(request_body)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**request_body** | [**::std::collections::HashMap<String, serde_json::Value>**](serde_json::Value.md) | You can filter the issues in your request by the `projects`, `archivedBy`, `archivedDate`, `issueTypes`, and `reporters` fields. All filters are optional. If you don't provide any filters, you'll get a list of up to one million archived issues. | [required] |

### Return type

[**crate::models::ExportArchivedIssuesTaskProgressResponse**](ExportArchivedIssuesTaskProgressResponse.md)
...
> crate::models::IssueArchivalSyncResponse unarchive_issues(issue_archival_sync_request)
