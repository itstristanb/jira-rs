...
> Vec<crate::models::WorkflowSchemeReadResponse> read_workflow_schemes(workflow_scheme_read_request, expand)
...
[**Vec<crate::models::WorkflowSchemeReadResponse>**](WorkflowSchemeReadResponse.md)
...
> serde_json::Value update_schemes(request_body)
...
> crate::models::WorkflowSchemeUpdateRequiredMappingsResponse update_workflow_scheme_mappings(workflow_scheme_update_required_mappings_request)
...
[**crate::models::WorkflowSchemeUpdateRequiredMappingsResponse**](WorkflowSchemeUpdateRequiredMappingsResponse.md)
