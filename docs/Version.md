...
------------ | ------------- | ------------- | -------------
**approvers** | Option<[**Vec<crate::models::VersionApprover>**](VersionApprover.md)> | If the expand option `approvers` is used, returns a list containing the approvers for this version. | [optional][readonly]
