...
pub struct WorkflowSchemeAssociations {
    ...
    pub workflow_scheme: Box<crate::models::WorkflowScheme>,
}

impl WorkflowSchemeAssociations {
    /// A workflow scheme along with a list of projects that use it.
    pub fn new(project_ids: Vec<String>, workflow_scheme: crate::models::WorkflowScheme) -> WorkflowSchemeAssociations {
