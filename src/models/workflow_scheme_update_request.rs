...
pub struct WorkflowSchemeUpdateRequest {
    ...
    pub status_mappings_by_issue_type_override: Option<Vec<crate::models::MappingsByIssueTypeOverride>>,
    ...
    pub status_mappings_by_workflows: Option<Vec<crate::models::MappingsByWorkflow>>,
    ...
    pub workflows_for_issue_types: Option<Vec<crate::models::WorkflowSchemeAssociation>>,
}

impl WorkflowSchemeUpdateRequest {
    /// The update workflow scheme payload.
    pub fn new(description: String, id: String, name: String, version: crate::models::DocumentVersion) -> WorkflowSchemeUpdateRequest {
