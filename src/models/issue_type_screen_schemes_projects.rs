...
pub struct IssueTypeScreenSchemesProjects {
    ...
    pub issue_type_screen_scheme: Box<crate::models::IssueTypeScreenScheme>,
...
impl IssueTypeScreenSchemesProjects {
    ...
    pub fn new(issue_type_screen_scheme: crate::models::IssueTypeScreenScheme, project_ids: Vec<String>) -> IssueTypeScreenSchemesProjects {
