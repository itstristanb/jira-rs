...
pub struct IssueTypeSchemeProjects {
    ...
    pub issue_type_scheme: Box<crate::models::IssueTypeScheme>,
...
impl IssueTypeSchemeProjects {
    ...
    pub fn new(issue_type_scheme: crate::models::IssueTypeScheme, project_ids: Vec<String>) -> IssueTypeSchemeProjects {
