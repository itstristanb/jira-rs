...
pub struct WorkflowSchemeUpdateRequiredMappingsResponse {
    ...
    pub status_mappings_by_issue_types: Option<Vec<crate::models::RequiredMappingByIssueType>>,
    /// The list of required status mappings by workflow.
    #[serde(rename = "statusMappingsByWorkflows", skip_serializing_if = "Option::is_none")]
    pub status_mappings_by_workflows: Option<Vec<crate::models::RequiredMappingByWorkflows>>,
    /// The details of the statuses in the associated workflows.
    #[serde(rename = "statuses", skip_serializing_if = "Option::is_none")]
    pub statuses: Option<Vec<crate::models::StatusMetadata>>,
    /// The statuses associated with each workflow.
    #[serde(rename = "statusesPerWorkflow", skip_serializing_if = "Option::is_none")]
    pub statuses_per_workflow: Option<Vec<crate::models::StatusesPerWorkflow>>,
}
