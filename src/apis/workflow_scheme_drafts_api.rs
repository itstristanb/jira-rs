...
pub async fn create_workflow_scheme_draft_from_parent(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::WorkflowScheme, Error<CreateWorkflowSchemeDraftFromParentError>> {
...
pub async fn delete_draft_default_workflow(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::WorkflowScheme, Error<DeleteDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_draft_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str) -> Result<crate::models::WorkflowScheme, Error<DeleteWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_draft_default_workflow(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::DefaultWorkflow, Error<GetDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_draft_workflow(configuration: &configuration::Configuration, id: i64, workflow_name: Option<&str>) -> Result<crate::models::IssueTypesWorkflowMapping, Error<GetDraftWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_draft(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::WorkflowScheme, Error<GetWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_draft_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str) -> Result<crate::models::IssueTypeWorkflowMapping, Error<GetWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn publish_draft_workflow_scheme(configuration: &configuration::Configuration, id: i64, publish_draft_workflow_scheme: crate::models::PublishDraftWorkflowScheme, validate_only: Option<bool>) -> Result<(), Error<PublishDraftWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn set_workflow_scheme_draft_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, issue_type_workflow_mapping: crate::models::IssueTypeWorkflowMapping) -> Result<crate::models::WorkflowScheme, Error<SetWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_draft_default_workflow(configuration: &configuration::Configuration, id: i64, default_workflow: crate::models::DefaultWorkflow) -> Result<crate::models::WorkflowScheme, Error<UpdateDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn update_draft_workflow_mapping(configuration: &configuration::Configuration, id: i64, workflow_name: &str, issue_types_workflow_mapping: crate::models::IssueTypesWorkflowMapping) -> Result<crate::models::WorkflowScheme, Error<UpdateDraftWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme_draft(configuration: &configuration::Configuration, id: i64, workflow_scheme: crate::models::WorkflowScheme) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
