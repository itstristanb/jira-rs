...
pub async fn create_issue_link_type(configuration: &configuration::Configuration, issue_link_type: crate::models::IssueLinkType) -> Result<crate::models::IssueLinkType, Error<CreateIssueLinkTypeError>> {
...
pub async fn get_issue_link_type(configuration: &configuration::Configuration, issue_link_type_id: &str) -> Result<crate::models::IssueLinkType, Error<GetIssueLinkTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_issue_link_type(configuration: &configuration::Configuration, issue_link_type_id: &str, issue_link_type: crate::models::IssueLinkType) -> Result<crate::models::IssueLinkType, Error<UpdateIssueLinkTypeError>> {
    let local_var_configuration = configuration;
