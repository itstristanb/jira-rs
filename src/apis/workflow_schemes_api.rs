...
pub async fn read_workflow_schemes(configuration: &configuration::Configuration, workflow_scheme_read_request: crate::models::WorkflowSchemeReadRequest, expand: Option<&str>) -> Result<Vec<crate::models::WorkflowSchemeReadResponse>, Error<ReadWorkflowSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_schemes(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<serde_json::Value, Error<UpdateSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme_mappings(configuration: &configuration::Configuration, workflow_scheme_update_required_mappings_request: crate::models::WorkflowSchemeUpdateRequiredMappingsRequest) -> Result<crate::models::WorkflowSchemeUpdateRequiredMappingsResponse, Error<UpdateWorkflowSchemeMappingsError>> {
    let local_var_configuration = configuration;
