...
pub async fn migration_resource_period_update_entity_properties_value_put(configuration: &configuration::Configuration, atlassian_transfer_id: &str, entity_type: &str, entity_property_details: Vec<crate::models::EntityPropertyDetails>) -> Result<(), Error<MigrationResourcePeriodUpdateEntityPropertiesValuePutError>> {
    let local_var_configuration = configuration;
...
pub async fn migration_resource_period_workflow_rule_search_post(configuration: &configuration::Configuration, atlassian_transfer_id: &str, workflow_rules_search: crate::models::WorkflowRulesSearch) -> Result<crate::models::WorkflowRulesSearchDetails, Error<MigrationResourcePeriodWorkflowRuleSearchPostError>> {
    let local_var_configuration = configuration;
