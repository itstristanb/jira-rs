...
pub async fn create_custom_field(configuration: &configuration::Configuration, custom_field_definition_json_bean: crate::models::CustomFieldDefinitionJsonBean) -> Result<crate::models::FieldDetails, Error<CreateCustomFieldError>> {
...
pub async fn get_contexts_for_field_deprecated(configuration: &configuration::Configuration, field_id: &str, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanContext, Error<GetContextsForFieldDeprecatedError>> {
    let local_var_configuration = configuration;
...
pub async fn get_fields_paginated(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, r#type: Option<Vec<String>>, id: Option<Vec<String>>, query: Option<&str>, order_by: Option<&str>, expand: Option<&str>) -> Result<crate::models::PageBeanField, Error<GetFieldsPaginatedError>> {
    let local_var_configuration = configuration;
...
pub async fn get_trashed_fields_paginated(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, id: Option<Vec<String>>, query: Option<&str>, expand: Option<&str>, order_by: Option<&str>) -> Result<crate::models::PageBeanField, Error<GetTrashedFieldsPaginatedError>> {
    let local_var_configuration = configuration;
...
pub async fn update_custom_field(configuration: &configuration::Configuration, field_id: &str, update_custom_field_details: crate::models::UpdateCustomFieldDetails) -> Result<serde_json::Value, Error<UpdateCustomFieldError>> {
    let local_var_configuration = configuration;
