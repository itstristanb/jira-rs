...
pub async fn create_permission_grant(configuration: &configuration::Configuration, scheme_id: i64, request_body: ::std::collections::HashMap<String, serde_json::Value>, expand: Option<&str>) -> Result<crate::models::PermissionGrant, Error<CreatePermissionGrantError>> {
