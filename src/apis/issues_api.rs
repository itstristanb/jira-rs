...
pub async fn archive_issues(configuration: &configuration::Configuration, issue_archival_sync_request: crate::models::IssueArchivalSyncRequest) -> Result<crate::models::IssueArchivalSyncResponse, Error<ArchiveIssuesError>> {
...
pub async fn archive_issues_async(configuration: &configuration::Configuration, archive_issue_async_request: crate::models::ArchiveIssueAsyncRequest) -> Result<String, Error<ArchiveIssuesAsyncError>> {
    let local_var_configuration = configuration;
...
pub async fn edit_issue(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, notify_users: Option<bool>, override_screen_security: Option<bool>, override_editable_flag: Option<bool>, return_issue: Option<bool>, expand: Option<&str>) -> Result<serde_json::Value, Error<EditIssueError>> {
    let local_var_configuration = configuration;
...
pub async fn export_archived_issues(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::ExportArchivedIssuesTaskProgressResponse, Error<ExportArchivedIssuesError>> {
    let local_var_configuration = configuration;
...
pub async fn unarchive_issues(configuration: &configuration::Configuration, issue_archival_sync_request: crate::models::IssueArchivalSyncRequest) -> Result<crate::models::IssueArchivalSyncResponse, Error<UnarchiveIssuesError>> {
    let local_var_configuration = configuration;
