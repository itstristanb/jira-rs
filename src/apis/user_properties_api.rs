...
pub async fn get_user_property(configuration: &configuration::Configuration, property_key: &str, account_id: Option<&str>, user_key: Option<&str>, username: Option<&str>) -> Result<crate::models::EntityProperty, Error<GetUserPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_property_keys(configuration: &configuration::Configuration, account_id: Option<&str>, user_key: Option<&str>, username: Option<&str>) -> Result<crate::models::PropertyKeys, Error<GetUserPropertyKeysError>> {
    let local_var_configuration = configuration;
