...
pub async fn get_issue_link(configuration: &configuration::Configuration, link_id: &str) -> Result<crate::models::IssueLink, Error<GetIssueLinkError>> {
    let local_var_configuration = configuration;
...
pub async fn link_issues(configuration: &configuration::Configuration, link_issue_request_json_bean: crate::models::LinkIssueRequestJsonBean) -> Result<serde_json::Value, Error<LinkIssuesError>> {
    let local_var_configuration = configuration;
