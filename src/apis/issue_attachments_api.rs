...
pub async fn add_attachment(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<Vec<crate::models::Attachment>, Error<AddAttachmentError>> {
...
pub async fn expand_attachment_for_humans(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::AttachmentArchiveMetadataReadable, Error<ExpandAttachmentForHumansError>> {
    let local_var_configuration = configuration;
...
pub async fn expand_attachment_for_machines(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::AttachmentArchiveImpl, Error<ExpandAttachmentForMachinesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_attachment(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::AttachmentMetadata, Error<GetAttachmentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_attachment_content(configuration: &configuration::Configuration, id: &str, redirect: Option<bool>) -> Result<serde_json::Value, Error<GetAttachmentContentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_attachment_meta(configuration: &configuration::Configuration, ) -> Result<crate::models::AttachmentSettings, Error<GetAttachmentMetaError>> {
    let local_var_configuration = configuration;
...
pub async fn get_attachment_thumbnail(configuration: &configuration::Configuration, id: &str, redirect: Option<bool>, fallback_to_default: Option<bool>, width: Option<i32>, height: Option<i32>) -> Result<serde_json::Value, Error<GetAttachmentThumbnailError>> {
    let local_var_configuration = configuration;
