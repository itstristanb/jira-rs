...
pub async fn dynamic_modules_resource_period_get_modules_get(configuration: &configuration::Configuration, ) -> Result<crate::models::ConnectModules, Error<DynamicModulesResourcePeriodGetModulesGetError>> {
...
pub async fn dynamic_modules_resource_period_register_modules_post(configuration: &configuration::Configuration, connect_modules: crate::models::ConnectModules) -> Result<(), Error<DynamicModulesResourcePeriodRegisterModulesPostError>> {
    let local_var_configuration = configuration;
