...
pub async fn add_user_to_group(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>, groupname: Option<&str>, group_id: Option<&str>) -> Result<crate::models::Group, Error<AddUserToGroupError>> {
...
pub async fn bulk_get_groups(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, group_id: Option<Vec<String>>, group_name: Option<Vec<String>>, access_type: Option<&str>, application_key: Option<&str>) -> Result<crate::models::PageBeanGroupDetails, Error<BulkGetGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn create_group(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::Group, Error<CreateGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn find_groups(configuration: &configuration::Configuration, account_id: Option<&str>, query: Option<&str>, exclude: Option<Vec<String>>, exclude_id: Option<Vec<String>>, max_results: Option<i32>, case_insensitive: Option<bool>, user_name: Option<&str>) -> Result<crate::models::FoundGroups, Error<FindGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group(configuration: &configuration::Configuration, groupname: Option<&str>, group_id: Option<&str>, expand: Option<&str>) -> Result<crate::models::Group, Error<GetGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_users_from_group(configuration: &configuration::Configuration, groupname: Option<&str>, group_id: Option<&str>, include_inactive_users: Option<bool>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanUserDetails, Error<GetUsersFromGroupError>> {
    let local_var_configuration = configuration;
