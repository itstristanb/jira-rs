...
pub async fn create_or_update_remote_issue_link(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::RemoteIssueLinkIdentifies, Error<CreateOrUpdateRemoteIssueLinkError>> {
...
pub async fn get_remote_issue_link_by_id(configuration: &configuration::Configuration, issue_id_or_key: &str, link_id: &str) -> Result<crate::models::RemoteIssueLink, Error<GetRemoteIssueLinkByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_remote_issue_links(configuration: &configuration::Configuration, issue_id_or_key: &str, global_id: Option<&str>) -> Result<crate::models::RemoteIssueLink, Error<GetRemoteIssueLinksError>> {
    let local_var_configuration = configuration;
...
pub async fn update_remote_issue_link(configuration: &configuration::Configuration, issue_id_or_key: &str, link_id: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<serde_json::Value, Error<UpdateRemoteIssueLinkError>> {
    let local_var_configuration = configuration;
