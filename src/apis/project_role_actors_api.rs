...
pub async fn add_actor_users(configuration: &configuration::Configuration, project_id_or_key: &str, id: i64, actors_map: crate::models::ActorsMap) -> Result<crate::models::ProjectRole, Error<AddActorUsersError>> {
...
pub async fn add_project_role_actors_to_role(configuration: &configuration::Configuration, id: i64, actor_input_bean: crate::models::ActorInputBean) -> Result<crate::models::ProjectRole, Error<AddProjectRoleActorsToRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_project_role_actors_from_role(configuration: &configuration::Configuration, id: i64, user: Option<&str>, group_id: Option<&str>, group: Option<&str>) -> Result<crate::models::ProjectRole, Error<DeleteProjectRoleActorsFromRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role_actors_for_role(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::ProjectRole, Error<GetProjectRoleActorsForRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn set_actors(configuration: &configuration::Configuration, project_id_or_key: &str, id: i64, project_role_actors_update_bean: crate::models::ProjectRoleActorsUpdateBean) -> Result<crate::models::ProjectRole, Error<SetActorsError>> {
    let local_var_configuration = configuration;
