...
pub async fn create_workflow_transition_property(configuration: &configuration::Configuration, transition_id: i64, key: &str, workflow_name: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, workflow_mode: Option<&str>) -> Result<crate::models::WorkflowTransitionProperty, Error<CreateWorkflowTransitionPropertyError>> {
...
pub async fn get_workflow_transition_properties(configuration: &configuration::Configuration, transition_id: i64, workflow_name: &str, include_reserved_keys: Option<bool>, key: Option<&str>, workflow_mode: Option<&str>) -> Result<crate::models::WorkflowTransitionProperty, Error<GetWorkflowTransitionPropertiesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_transition_property(configuration: &configuration::Configuration, transition_id: i64, key: &str, workflow_name: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, workflow_mode: Option<&str>) -> Result<crate::models::WorkflowTransitionProperty, Error<UpdateWorkflowTransitionPropertyError>> {
    let local_var_configuration = configuration;
