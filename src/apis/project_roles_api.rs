...
pub async fn create_project_role(configuration: &configuration::Configuration, create_update_role_request_bean: crate::models::CreateUpdateRoleRequestBean) -> Result<crate::models::ProjectRole, Error<CreateProjectRoleError>> {
...
pub async fn fully_update_project_role(configuration: &configuration::Configuration, id: i64, create_update_role_request_bean: crate::models::CreateUpdateRoleRequestBean) -> Result<crate::models::ProjectRole, Error<FullyUpdateProjectRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_project_roles(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::ProjectRole>, Error<GetAllProjectRolesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role(configuration: &configuration::Configuration, project_id_or_key: &str, id: i64, exclude_inactive_users: Option<bool>) -> Result<crate::models::ProjectRole, Error<GetProjectRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role_by_id(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::ProjectRole, Error<GetProjectRoleByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role_details(configuration: &configuration::Configuration, project_id_or_key: &str, current_member: Option<bool>, exclude_connect_addons: Option<bool>) -> Result<Vec<crate::models::ProjectRoleDetails>, Error<GetProjectRoleDetailsError>> {
    let local_var_configuration = configuration;
...
pub async fn partial_update_project_role(configuration: &configuration::Configuration, id: i64, create_update_role_request_bean: crate::models::CreateUpdateRoleRequestBean) -> Result<crate::models::ProjectRole, Error<PartialUpdateProjectRoleError>> {
    let local_var_configuration = configuration;
