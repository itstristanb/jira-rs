...
pub async fn create_issue_field_option(configuration: &configuration::Configuration, field_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::IssueFieldOption, Error<CreateIssueFieldOptionError>> {
...
pub async fn get_all_issue_field_options(configuration: &configuration::Configuration, field_key: &str, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanIssueFieldOption, Error<GetAllIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_field_option(configuration: &configuration::Configuration, field_key: &str, option_id: i64) -> Result<crate::models::IssueFieldOption, Error<GetIssueFieldOptionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_selectable_issue_field_options(configuration: &configuration::Configuration, field_key: &str, start_at: Option<i64>, max_results: Option<i32>, project_id: Option<i64>) -> Result<crate::models::PageBeanIssueFieldOption, Error<GetSelectableIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_visible_issue_field_options(configuration: &configuration::Configuration, field_key: &str, start_at: Option<i64>, max_results: Option<i32>, project_id: Option<i64>) -> Result<crate::models::PageBeanIssueFieldOption, Error<GetVisibleIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_issue_field_option(configuration: &configuration::Configuration, field_key: &str, option_id: i64, issue_field_option: crate::models::IssueFieldOption) -> Result<crate::models::IssueFieldOption, Error<UpdateIssueFieldOptionError>> {
    let local_var_configuration = configuration;
