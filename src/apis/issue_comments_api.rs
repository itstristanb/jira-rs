...
pub async fn add_comment(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, expand: Option<&str>) -> Result<crate::models::Comment, Error<AddCommentError>> {
...
pub async fn get_comment(configuration: &configuration::Configuration, issue_id_or_key: &str, id: &str, expand: Option<&str>) -> Result<crate::models::Comment, Error<GetCommentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_comments(configuration: &configuration::Configuration, issue_id_or_key: &str, start_at: Option<i64>, max_results: Option<i32>, order_by: Option<&str>, expand: Option<&str>) -> Result<crate::models::PageOfComments, Error<GetCommentsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_comments_by_ids(configuration: &configuration::Configuration, issue_comment_list_request_bean: crate::models::IssueCommentListRequestBean, expand: Option<&str>) -> Result<crate::models::PageBeanComment, Error<GetCommentsByIdsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_comment(configuration: &configuration::Configuration, issue_id_or_key: &str, id: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, notify_users: Option<bool>, override_editable_flag: Option<bool>, expand: Option<&str>) -> Result<crate::models::Comment, Error<UpdateCommentError>> {
    let local_var_configuration = configuration;
