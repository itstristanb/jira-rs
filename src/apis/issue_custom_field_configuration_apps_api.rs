...
pub async fn update_custom_field_configuration(configuration: &configuration::Configuration, field_id_or_key: &str, custom_field_configurations: crate::models::CustomFieldConfigurations) -> Result<serde_json::Value, Error<UpdateCustomFieldConfigurationError>> {
    let local_var_configuration = configuration;
