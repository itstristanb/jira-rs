...
pub async fn add_issue_types_to_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64, issue_type_ids: crate::models::IssueTypeIds) -> Result<serde_json::Value, Error<AddIssueTypesToIssueTypeSchemeError>> {
...
pub async fn assign_issue_type_scheme_to_project(configuration: &configuration::Configuration, issue_type_scheme_project_association: crate::models::IssueTypeSchemeProjectAssociation) -> Result<serde_json::Value, Error<AssignIssueTypeSchemeToProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn create_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_details: crate::models::IssueTypeSchemeDetails) -> Result<crate::models::IssueTypeSchemeId, Error<CreateIssueTypeSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_issue_type_schemes(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, id: Option<Vec<i64>>, order_by: Option<&str>, expand: Option<&str>, query_string: Option<&str>) -> Result<crate::models::PageBeanIssueTypeScheme, Error<GetAllIssueTypeSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type_scheme_for_projects(configuration: &configuration::Configuration, project_id: Vec<i64>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanIssueTypeSchemeProjects, Error<GetIssueTypeSchemeForProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type_schemes_mapping(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, issue_type_scheme_id: Option<Vec<i64>>) -> Result<crate::models::PageBeanIssueTypeSchemeMapping, Error<GetIssueTypeSchemesMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn reorder_issue_types_in_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64, order_of_issue_types: crate::models::OrderOfIssueTypes) -> Result<serde_json::Value, Error<ReorderIssueTypesInIssueTypeSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64, issue_type_scheme_update_details: crate::models::IssueTypeSchemeUpdateDetails) -> Result<serde_json::Value, Error<UpdateIssueTypeSchemeError>> {
    let local_var_configuration = configuration;
