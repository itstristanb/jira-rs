...
pub async fn create_project_category(configuration: &configuration::Configuration, project_category: crate::models::ProjectCategory) -> Result<crate::models::ProjectCategory, Error<CreateProjectCategoryError>> {
...
pub async fn get_project_category_by_id(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::ProjectCategory, Error<GetProjectCategoryByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project_category(configuration: &configuration::Configuration, id: i64, project_category: crate::models::ProjectCategory) -> Result<crate::models::UpdatedProjectCategory, Error<UpdateProjectCategoryError>> {
    let local_var_configuration = configuration;
