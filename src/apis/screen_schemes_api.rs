...
pub async fn create_screen_scheme(configuration: &configuration::Configuration, screen_scheme_details: crate::models::ScreenSchemeDetails) -> Result<crate::models::ScreenSchemeId, Error<CreateScreenSchemeError>> {
...
pub async fn get_screen_schemes(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, id: Option<Vec<i64>>, expand: Option<&str>, query_string: Option<&str>, order_by: Option<&str>) -> Result<crate::models::PageBeanScreenScheme, Error<GetScreenSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_screen_scheme(configuration: &configuration::Configuration, screen_scheme_id: &str, update_screen_scheme_details: crate::models::UpdateScreenSchemeDetails) -> Result<serde_json::Value, Error<UpdateScreenSchemeError>> {
    let local_var_configuration = configuration;
