...
pub async fn delete_webhook_by_id(configuration: &configuration::Configuration, container_for_webhook_ids: crate::models::ContainerForWebhookIds) -> Result<(), Error<DeleteWebhookByIdError>> {
...
pub async fn get_dynamic_webhooks_for_app(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanWebhook, Error<GetDynamicWebhooksForAppError>> {
    let local_var_configuration = configuration;
...
pub async fn get_failed_webhooks(configuration: &configuration::Configuration, max_results: Option<i32>, after: Option<i64>) -> Result<crate::models::FailedWebhooks, Error<GetFailedWebhooksError>> {
    let local_var_configuration = configuration;
...
pub async fn refresh_webhooks(configuration: &configuration::Configuration, container_for_webhook_ids: crate::models::ContainerForWebhookIds) -> Result<crate::models::WebhooksExpirationDate, Error<RefreshWebhooksError>> {
    let local_var_configuration = configuration;
...
pub async fn register_dynamic_webhooks(configuration: &configuration::Configuration, webhook_registration_details: crate::models::WebhookRegistrationDetails) -> Result<crate::models::ContainerForRegisteredWebhooks, Error<RegisterDynamicWebhooksError>> {
    let local_var_configuration = configuration;
