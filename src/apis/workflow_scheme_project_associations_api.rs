...
pub async fn assign_scheme_to_project(configuration: &configuration::Configuration, workflow_scheme_project_association: crate::models::WorkflowSchemeProjectAssociation) -> Result<serde_json::Value, Error<AssignSchemeToProjectError>> {
...
pub async fn get_workflow_scheme_project_associations(configuration: &configuration::Configuration, project_id: Vec<i64>) -> Result<crate::models::ContainerOfWorkflowSchemeAssociations, Error<GetWorkflowSchemeProjectAssociationsError>> {
    let local_var_configuration = configuration;
