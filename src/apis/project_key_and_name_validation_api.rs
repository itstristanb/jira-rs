...
pub async fn validate_project_key(configuration: &configuration::Configuration, key: Option<&str>) -> Result<crate::models::ErrorCollection, Error<ValidateProjectKeyError>> {
    let local_var_configuration = configuration;
