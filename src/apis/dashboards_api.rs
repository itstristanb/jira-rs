...
pub async fn bulk_edit_dashboards(configuration: &configuration::Configuration, bulk_edit_shareable_entity_request: crate::models::BulkEditShareableEntityRequest) -> Result<crate::models::BulkEditShareableEntityResponse, Error<BulkEditDashboardsError>> {
    let local_var_configuration = configuration;
