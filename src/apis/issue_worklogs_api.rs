...
pub async fn add_worklog(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, notify_users: Option<bool>, adjust_estimate: Option<&str>, new_estimate: Option<&str>, reduce_by: Option<&str>, expand: Option<&str>, override_editable_flag: Option<bool>) -> Result<crate::models::Worklog, Error<AddWorklogError>> {
...
pub async fn get_ids_of_worklogs_deleted_since(configuration: &configuration::Configuration, since: Option<i64>) -> Result<crate::models::ChangedWorklogs, Error<GetIdsOfWorklogsDeletedSinceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_ids_of_worklogs_modified_since(configuration: &configuration::Configuration, since: Option<i64>, expand: Option<&str>) -> Result<crate::models::ChangedWorklogs, Error<GetIdsOfWorklogsModifiedSinceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_worklog(configuration: &configuration::Configuration, issue_id_or_key: &str, start_at: Option<i64>, max_results: Option<i32>, started_after: Option<i64>, started_before: Option<i64>, expand: Option<&str>) -> Result<crate::models::PageOfWorklogs, Error<GetIssueWorklogError>> {
    let local_var_configuration = configuration;
...
pub async fn get_worklog(configuration: &configuration::Configuration, issue_id_or_key: &str, id: &str, expand: Option<&str>) -> Result<crate::models::Worklog, Error<GetWorklogError>> {
    let local_var_configuration = configuration;
...
pub async fn get_worklogs_for_ids(configuration: &configuration::Configuration, worklog_ids_request_bean: crate::models::WorklogIdsRequestBean, expand: Option<&str>) -> Result<Vec<crate::models::Worklog>, Error<GetWorklogsForIdsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_worklog(configuration: &configuration::Configuration, issue_id_or_key: &str, id: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, notify_users: Option<bool>, adjust_estimate: Option<&str>, new_estimate: Option<&str>, expand: Option<&str>, override_editable_flag: Option<bool>) -> Result<crate::models::Worklog, Error<UpdateWorklogError>> {
    let local_var_configuration = configuration;
