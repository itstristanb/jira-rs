...
pub async fn get_all_system_avatars(configuration: &configuration::Configuration, r#type: &str) -> Result<crate::models::SystemAvatars, Error<GetAllSystemAvatarsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatars(configuration: &configuration::Configuration, r#type: &str, entity_id: &str) -> Result<crate::models::Avatars, Error<GetAvatarsError>> {
    let local_var_configuration = configuration;
...
pub async fn store_avatar(configuration: &configuration::Configuration, r#type: &str, entity_id: &str, size: i32, body: Option<serde_json::Value>, x: Option<i32>, y: Option<i32>) -> Result<crate::models::Avatar, Error<StoreAvatarError>> {
    let local_var_configuration = configuration;
