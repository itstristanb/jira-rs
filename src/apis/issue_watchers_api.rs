...
pub async fn get_is_watching_issue_bulk(configuration: &configuration::Configuration, issue_list: crate::models::IssueList) -> Result<crate::models::BulkIssueIsWatching, Error<GetIsWatchingIssueBulkError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_watchers(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<crate::models::Watchers, Error<GetIssueWatchersError>> {
    let local_var_configuration = configuration;
