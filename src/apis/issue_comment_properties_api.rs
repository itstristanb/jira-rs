...
pub async fn get_comment_property(configuration: &configuration::Configuration, comment_id: &str, property_key: &str) -> Result<crate::models::EntityProperty, Error<GetCommentPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_comment_property_keys(configuration: &configuration::Configuration, comment_id: &str) -> Result<crate::models::PropertyKeys, Error<GetCommentPropertyKeysError>> {
    let local_var_configuration = configuration;
