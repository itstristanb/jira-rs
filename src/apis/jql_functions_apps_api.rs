...
pub async fn get_precomputations(configuration: &configuration::Configuration, function_key: Option<Vec<String>>, start_at: Option<i64>, max_results: Option<i32>, order_by: Option<&str>) -> Result<crate::models::PageBeanJqlFunctionPrecomputationBean, Error<GetPrecomputationsError>> {
