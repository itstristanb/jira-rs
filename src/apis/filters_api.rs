...
pub async fn change_filter_owner(configuration: &configuration::Configuration, id: i64, change_filter_owner: crate::models::ChangeFilterOwner) -> Result<serde_json::Value, Error<ChangeFilterOwnerError>> {
...
pub async fn create_filter(configuration: &configuration::Configuration, filter: crate::models::Filter, expand: Option<&str>, override_share_permissions: Option<bool>) -> Result<crate::models::Filter, Error<CreateFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_favourite_for_filter(configuration: &configuration::Configuration, id: i64, expand: Option<&str>) -> Result<crate::models::Filter, Error<DeleteFavouriteForFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn get_columns(configuration: &configuration::Configuration, id: i64) -> Result<Vec<crate::models::ColumnItem>, Error<GetColumnsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favourite_filters(configuration: &configuration::Configuration, expand: Option<&str>) -> Result<Vec<crate::models::Filter>, Error<GetFavouriteFiltersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_filter(configuration: &configuration::Configuration, id: i64, expand: Option<&str>, override_share_permissions: Option<bool>) -> Result<crate::models::Filter, Error<GetFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn get_my_filters(configuration: &configuration::Configuration, expand: Option<&str>, include_favourites: Option<bool>) -> Result<Vec<crate::models::Filter>, Error<GetMyFiltersError>> {
    let local_var_configuration = configuration;
...
pub async fn set_favourite_for_filter(configuration: &configuration::Configuration, id: i64, expand: Option<&str>) -> Result<crate::models::Filter, Error<SetFavouriteForFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn update_filter(configuration: &configuration::Configuration, id: i64, filter: crate::models::Filter, expand: Option<&str>, override_share_permissions: Option<bool>) -> Result<crate::models::Filter, Error<UpdateFilterError>> {
    let local_var_configuration = configuration;
