...
pub async fn get_project_property(configuration: &configuration::Configuration, project_id_or_key: &str, property_key: &str) -> Result<crate::models::EntityProperty, Error<GetProjectPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_property_keys(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<crate::models::PropertyKeys, Error<GetProjectPropertyKeysError>> {
    let local_var_configuration = configuration;
