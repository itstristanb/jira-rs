...
pub async fn get_audit_records(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, filter: Option<&str>, from: Option<String>, to: Option<String>) -> Result<crate::models::AuditRecords, Error<GetAuditRecordsError>> {
