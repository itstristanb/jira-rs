...
pub async fn search_priorities(configuration: &configuration::Configuration, start_at: Option<&str>, max_results: Option<&str>, id: Option<Vec<String>>, project_id: Option<Vec<String>>, only_default: Option<bool>) -> Result<crate::models::PageBeanPriority, Error<SearchPrioritiesError>> {
    let local_var_configuration = configuration;
