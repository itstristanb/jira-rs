...
pub async fn create_custom_field_option(configuration: &configuration::Configuration, field_id: &str, context_id: i64, bulk_custom_field_option_create_request: crate::models::BulkCustomFieldOptionCreateRequest) -> Result<crate::models::CustomFieldCreatedContextOptionsList, Error<CreateCustomFieldOptionError>> {
...
pub async fn get_custom_field_option(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::CustomFieldOption, Error<GetCustomFieldOptionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_options_for_context(configuration: &configuration::Configuration, field_id: &str, context_id: i64, option_id: Option<i64>, only_options: Option<bool>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanCustomFieldContextOption, Error<GetOptionsForContextError>> {
    let local_var_configuration = configuration;
...
pub async fn reorder_custom_field_options(configuration: &configuration::Configuration, field_id: &str, context_id: i64, order_of_custom_field_options: crate::models::OrderOfCustomFieldOptions) -> Result<serde_json::Value, Error<ReorderCustomFieldOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_custom_field_option(configuration: &configuration::Configuration, field_id: &str, context_id: i64, bulk_custom_field_option_update_request: crate::models::BulkCustomFieldOptionUpdateRequest) -> Result<crate::models::CustomFieldUpdatedContextOptionsList, Error<UpdateCustomFieldOptionError>> {
    let local_var_configuration = configuration;
