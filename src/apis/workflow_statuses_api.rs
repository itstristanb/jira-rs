...
pub async fn get_status(configuration: &configuration::Configuration, id_or_name: &str) -> Result<crate::models::StatusDetails, Error<GetStatusError>> {
...
pub async fn get_statuses(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::StatusDetails>, Error<GetStatusesError>> {
    let local_var_configuration = configuration;
