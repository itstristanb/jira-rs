...
pub async fn get_all_permissions(configuration: &configuration::Configuration, ) -> Result<crate::models::Permissions, Error<GetAllPermissionsError>> {
...
pub async fn get_bulk_permissions(configuration: &configuration::Configuration, bulk_permissions_request_bean: crate::models::BulkPermissionsRequestBean) -> Result<crate::models::BulkPermissionGrants, Error<GetBulkPermissionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_permitted_projects(configuration: &configuration::Configuration, permissions_keys_bean: crate::models::PermissionsKeysBean) -> Result<crate::models::PermittedProjects, Error<GetPermittedProjectsError>> {
    let local_var_configuration = configuration;
