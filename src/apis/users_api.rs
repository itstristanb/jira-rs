...
pub async fn bulk_get_users(configuration: &configuration::Configuration, account_id: Vec<String>, start_at: Option<i64>, max_results: Option<i32>, username: Option<Vec<String>>, key: Option<Vec<String>>) -> Result<crate::models::PageBeanUser, Error<BulkGetUsersError>> {
...
pub async fn bulk_get_users_migration(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, username: Option<Vec<String>>, key: Option<Vec<String>>) -> Result<Vec<crate::models::UserMigrationBean>, Error<BulkGetUsersMigrationError>> {
    let local_var_configuration = configuration;
...
pub async fn create_user(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::User, Error<CreateUserError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_users(configuration: &configuration::Configuration, start_at: Option<i32>, max_results: Option<i32>) -> Result<Vec<crate::models::User>, Error<GetAllUsersError>> {
    let local_var_configuration = configuration;
...
/// Returns a list of all users, including active users, inactive users and previously deleted users that have an Atlassian account.  Privacy controls are applied to the response based on the users' preferences. This could mean, for example, that the user's email address is hidden. See the [Profile visibility overview](https://developer.atlassian.com/cloud/jira/platform/profile-visibility/) for more details.  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg).
pub async fn get_all_users_default(configuration: &configuration::Configuration, start_at: Option<i32>, max_results: Option<i32>) -> Result<Vec<crate::models::User>, Error<GetAllUsersDefaultError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user(configuration: &configuration::Configuration, account_id: Option<&str>, username: Option<&str>, key: Option<&str>, expand: Option<&str>) -> Result<crate::models::User, Error<GetUserError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_default_columns(configuration: &configuration::Configuration, account_id: Option<&str>, username: Option<&str>) -> Result<Vec<crate::models::ColumnItem>, Error<GetUserDefaultColumnsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_email(configuration: &configuration::Configuration, account_id: &str) -> Result<crate::models::UnrestrictedUserEmail, Error<GetUserEmailError>> {
    let local_var_configuration = configuration;
...
/// Returns a user's email address. This API is only available to apps approved by Atlassian, according to these [guidelines](https://community.developer.atlassian.com/t/guidelines-for-requesting-access-to-email-address/27603).
pub async fn get_user_email_bulk(configuration: &configuration::Configuration, account_id: Vec<String>) -> Result<crate::models::UnrestrictedUserEmail, Error<GetUserEmailBulkError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_groups(configuration: &configuration::Configuration, account_id: &str, username: Option<&str>, key: Option<&str>) -> Result<Vec<crate::models::GroupName>, Error<GetUserGroupsError>> {
    let local_var_configuration = configuration;
