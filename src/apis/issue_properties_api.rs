...
pub async fn bulk_delete_issue_property(configuration: &configuration::Configuration, property_key: &str, issue_filter_for_bulk_property_delete: crate::models::IssueFilterForBulkPropertyDelete) -> Result<(), Error<BulkDeleteIssuePropertyError>> {
...
pub async fn bulk_set_issue_properties_by_issue(configuration: &configuration::Configuration, multi_issue_entity_properties: crate::models::MultiIssueEntityProperties) -> Result<(), Error<BulkSetIssuePropertiesByIssueError>> {
    let local_var_configuration = configuration;
...
pub async fn bulk_set_issue_property(configuration: &configuration::Configuration, property_key: &str, bulk_issue_property_update_request: crate::models::BulkIssuePropertyUpdateRequest) -> Result<(), Error<BulkSetIssuePropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn bulk_set_issues_properties_list(configuration: &configuration::Configuration, issue_entity_properties: crate::models::IssueEntityProperties) -> Result<(), Error<BulkSetIssuesPropertiesListError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_property(configuration: &configuration::Configuration, issue_id_or_key: &str, property_key: &str) -> Result<crate::models::EntityProperty, Error<GetIssuePropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_property_keys(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<crate::models::PropertyKeys, Error<GetIssuePropertyKeysError>> {
    let local_var_configuration = configuration;
