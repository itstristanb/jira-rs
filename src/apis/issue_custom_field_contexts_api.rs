...
pub async fn add_issue_types_to_context(configuration: &configuration::Configuration, field_id: &str, context_id: i64, issue_type_ids: crate::models::IssueTypeIds) -> Result<serde_json::Value, Error<AddIssueTypesToContextError>> {
...
pub async fn assign_projects_to_custom_field_context(configuration: &configuration::Configuration, field_id: &str, context_id: i64, project_ids: crate::models::ProjectIds) -> Result<serde_json::Value, Error<AssignProjectsToCustomFieldContextError>> {
    let local_var_configuration = configuration;
...
pub async fn create_custom_field_context(configuration: &configuration::Configuration, field_id: &str, create_custom_field_context: crate::models::CreateCustomFieldContext) -> Result<crate::models::CreateCustomFieldContext, Error<CreateCustomFieldContextError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contexts_for_field(configuration: &configuration::Configuration, field_id: &str, is_any_issue_type: Option<bool>, is_global_context: Option<bool>, context_id: Option<Vec<i64>>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanCustomFieldContext, Error<GetContextsForFieldError>> {
    let local_var_configuration = configuration;
...
pub async fn get_custom_field_contexts_for_projects_and_issue_types(configuration: &configuration::Configuration, field_id: &str, project_issue_type_mappings: crate::models::ProjectIssueTypeMappings, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanContextForProjectAndIssueType, Error<GetCustomFieldContextsForProjectsAndIssueTypesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_default_values(configuration: &configuration::Configuration, field_id: &str, context_id: Option<Vec<i64>>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanCustomFieldContextDefaultValue, Error<GetDefaultValuesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type_mappings_for_contexts(configuration: &configuration::Configuration, field_id: &str, context_id: Option<Vec<i64>>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanIssueTypeToContextMapping, Error<GetIssueTypeMappingsForContextsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_context_mapping(configuration: &configuration::Configuration, field_id: &str, context_id: Option<Vec<i64>>, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanCustomFieldContextProjectMapping, Error<GetProjectContextMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_custom_field_context_from_projects(configuration: &configuration::Configuration, field_id: &str, context_id: i64, project_ids: crate::models::ProjectIds) -> Result<serde_json::Value, Error<RemoveCustomFieldContextFromProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_issue_types_from_context(configuration: &configuration::Configuration, field_id: &str, context_id: i64, issue_type_ids: crate::models::IssueTypeIds) -> Result<serde_json::Value, Error<RemoveIssueTypesFromContextError>> {
    let local_var_configuration = configuration;
...
pub async fn set_default_values(configuration: &configuration::Configuration, field_id: &str, custom_field_context_default_value_update: crate::models::CustomFieldContextDefaultValueUpdate) -> Result<serde_json::Value, Error<SetDefaultValuesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_custom_field_context(configuration: &configuration::Configuration, field_id: &str, context_id: i64, custom_field_context_update_details: crate::models::CustomFieldContextUpdateDetails) -> Result<serde_json::Value, Error<UpdateCustomFieldContextError>> {
    let local_var_configuration = configuration;
