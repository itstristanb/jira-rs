...
pub async fn get_advanced_settings(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::ApplicationProperty>, Error<GetAdvancedSettingsError>> {
...
pub async fn get_application_property(configuration: &configuration::Configuration, key: Option<&str>, permission_level: Option<&str>, key_filter: Option<&str>) -> Result<Vec<crate::models::ApplicationProperty>, Error<GetApplicationPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn set_application_property(configuration: &configuration::Configuration, id: &str, simple_application_property_bean: crate::models::SimpleApplicationPropertyBean) -> Result<crate::models::ApplicationProperty, Error<SetApplicationPropertyError>> {
    let local_var_configuration = configuration;
