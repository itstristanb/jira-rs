...
pub async fn match_issues(configuration: &configuration::Configuration, issues_and_jql_queries: crate::models::IssuesAndJqlQueries) -> Result<crate::models::IssueMatches, Error<MatchIssuesError>> {
    let local_var_configuration = configuration;
...
pub async fn search_for_issues_using_jql_post(configuration: &configuration::Configuration, search_request_bean: crate::models::SearchRequestBean) -> Result<crate::models::SearchResults, Error<SearchForIssuesUsingJqlPostError>> {
    let local_var_configuration = configuration;
