...
pub async fn get_project_email(configuration: &configuration::Configuration, project_id: i64) -> Result<crate::models::ProjectEmailAddress, Error<GetProjectEmailError>> {
...
pub async fn update_project_email(configuration: &configuration::Configuration, project_id: i64, project_email_address: crate::models::ProjectEmailAddress) -> Result<serde_json::Value, Error<UpdateProjectEmailError>> {
    let local_var_configuration = configuration;
