...
pub async fn create_workflows(configuration: &configuration::Configuration, workflow_create_request: crate::models::WorkflowCreateRequest) -> Result<crate::models::WorkflowCreateResponse, Error<CreateWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn read_workflows(configuration: &configuration::Configuration, workflow_read_request: crate::models::WorkflowReadRequest, expand: Option<&str>) -> Result<crate::models::WorkflowReadResponse, Error<ReadWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflows(configuration: &configuration::Configuration, workflow_update_request: crate::models::WorkflowUpdateRequest, expand: Option<&str>) -> Result<crate::models::WorkflowUpdateResponse, Error<UpdateWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn validate_create_workflows(configuration: &configuration::Configuration, workflow_create_validate_request: crate::models::WorkflowCreateValidateRequest) -> Result<crate::models::WorkflowValidationErrorList, Error<ValidateCreateWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn validate_update_workflows(configuration: &configuration::Configuration, workflow_update_validate_request_bean: crate::models::WorkflowUpdateValidateRequestBean) -> Result<crate::models::WorkflowValidationErrorList, Error<ValidateUpdateWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn workflow_capabilities(configuration: &configuration::Configuration, workflow_id: Option<&str>, project_id: Option<&str>, issue_type_id: Option<&str>) -> Result<crate::models::WorkflowCapabilities, Error<WorkflowCapabilitiesError>> {
    let local_var_configuration = configuration;
