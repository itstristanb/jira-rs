...
pub async fn analyse_expression(configuration: &configuration::Configuration, jira_expression_for_analysis: crate::models::JiraExpressionForAnalysis, check: Option<&str>) -> Result<crate::models::JiraExpressionsAnalysis, Error<AnalyseExpressionError>> {
...
pub async fn evaluate_jira_expression(configuration: &configuration::Configuration, jira_expression_eval_request_bean: crate::models::JiraExpressionEvalRequestBean, expand: Option<&str>) -> Result<crate::models::JiraExpressionResult, Error<EvaluateJiraExpressionError>> {
    let local_var_configuration = configuration;
