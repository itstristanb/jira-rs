...
pub async fn get_current_user(configuration: &configuration::Configuration, expand: Option<&str>) -> Result<crate::models::User, Error<GetCurrentUserError>> {
    let local_var_configuration = configuration;
...
pub async fn get_locale(configuration: &configuration::Configuration, ) -> Result<crate::models::Locale, Error<GetLocaleError>> {
    let local_var_configuration = configuration;
...
pub async fn set_locale(configuration: &configuration::Configuration, locale: crate::models::Locale) -> Result<serde_json::Value, Error<SetLocaleError>> {
    let local_var_configuration = configuration;
