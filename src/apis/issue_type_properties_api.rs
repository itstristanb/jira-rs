...
pub async fn get_issue_type_property(configuration: &configuration::Configuration, issue_type_id: &str, property_key: &str) -> Result<crate::models::EntityProperty, Error<GetIssueTypePropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type_property_keys(configuration: &configuration::Configuration, issue_type_id: &str) -> Result<crate::models::PropertyKeys, Error<GetIssueTypePropertyKeysError>> {
    let local_var_configuration = configuration;
